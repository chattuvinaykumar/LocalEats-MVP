...
export default function RestaurantDetailScreen() {
  ...
  const loadOffers = async () => {
    try {
      ...
      console.warn("Could not load offers for restaurant:", e);
    }
  };
  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Restaurant Specific Active Offers */}
        {offers.length > 0 && (
          <View style={styles.offersContainer}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.offersScrollContent}>
              {offers.map(offer => (
                <View key={offer.id} style={styles.detailOfferItem}>
                  <View style={styles.detailOfferMain}>
                    <Text style={styles.detailOfferAmt}>{offer.discountPercentage}% OFF</Text>
                    <Text style={styles.detailOfferTitle} numberOfLines={1}>{offer.title}</Text>
                  </View>
                  <Text style={styles.detailOfferDesc} numberOfLines={1}>{offer.description}</Text>
                </View>
              ))}
            </ScrollView>
          </View>
